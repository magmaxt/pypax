...
folder_name='241103-T1273-V2e-14/'
...
strainrate_theory_newtonian = A * stress_theory**1 * np.exp(-Q/(R*T))  * 5e15 #5e20
...
# strainrate_theory_newtonian_loc = A * stress_theory**1 * np.exp(-Q/(R*T)) 
...
f2.loglog(stress_theory, strainrate_theory_loc, 
          'm-', label='dislocation creep \n Zhang et al., 2006; T=1073K')

f2.loglog(stress_theory, strainrate_theory_loc_1473, 
...
f2.set_ylim([1e-14*100, 1e-12*100])
